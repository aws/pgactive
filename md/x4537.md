  ...
  [Prev](x4424.md "Upgrading BDR 1.0 to BDR 2.0 and Postgres-BDR 9.4 to PostgreSQL 9.6")   [Up](upgrade.md)    Chapter 14. Upgrading [BDR]    [Next](x4541.md "Upgrading 0.8.x to 1.0")  
...
For upgrade instructions see the 1.0 manual.
  ...
  --------------------------------------------------------------------- ----------------------------------- -----------------------------------
  [Prev](x4424.md)                                      [Home](README.md)    [Next](x4541.md)  
