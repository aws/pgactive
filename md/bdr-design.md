...
To take a BDR node that has already been removed, or one that has been restored from a base backup, and turn it back into a normal PostgreSQL database you may use the `bdr.remove_bdr_from_local_node()` function.
