  ...
  ----------------------------------------------------------------------- ----------------------------------- ------------------------------------------- ----------------------------------------------------------------
  [Prev](x4376.md "Upgrading 2.0.x to 2.0.y releases")   [Up](upgrade.md)    Chapter 14. Upgrading [BDR]    [Next](x4492.md "Upgrading BDR 0.9.x to 1.0")  
...
2ndQuadrant](http://2ndquadrant.com).
  ...
  ----------------------------------- ----------------------------------- -----------------------------------
  [Prev](x4376.md)    [Home](README.md)    [Next](x4492.md)  
