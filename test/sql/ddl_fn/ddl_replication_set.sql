...
\c postgres
SELECT pgactive.pgactive_replicate_ddl_command($DDL$ CREATE SCHEMA normalschema; $DDL$);
SELECT pgactive.pgactive_replicate_ddl_command($DDL$ CREATE SCHEMA "strange.schema-IS"; $DDL$);
SELECT pgactive.pgactive_replicate_ddl_command($DDL$ CREATE TABLE public.switcheroo(id serial primary key, data text); $DDL$);
SELECT pgactive.pgactive_replicate_ddl_command($DDL$ CREATE TABLE normalschema.sometbl_normalschema(); $DDL$);
SELECT pgactive.pgactive_replicate_ddl_command($DDL$ CREATE TABLE "strange.schema-IS".sometbl_strangeschema(); $DDL$);
...
\c postgres
SELECT pgactive.pgactive_replicate_ddl_command($DDL$ DROP TABLE public.switcheroo; $DDL$);
SELECT pgactive.pgactive_replicate_ddl_command($DDL$ DROP TABLE normalschema.sometbl_normalschema; $DDL$);
SELECT pgactive.pgactive_replicate_ddl_command($DDL$ DROP TABLE "strange.schema-IS".sometbl_strangeschema; $DDL$);
...
SELECT pgactive.pgactive_replicate_ddl_command($DDL$ CREATE TABLE public.settest_1(data text primary key); $DDL$);
...
SELECT * FROM settest_1 ORDER BY data;
\c postgres
SELECT pgactive.pgactive_replicate_ddl_command($DDL$ DROP TABLE public.settest_1; $DDL$);


/*
 * Now test configurations where only some actions are replicated.
 */
SELECT pgactive.pgactive_replicate_ddl_command($DDL$ CREATE TABLE public.settest_2(data text primary key); $DDL$);
...
SELECT pgactive.pgactive_replicate_ddl_command($DDL$ DROP TABLE public.settest_2; $DDL$);
SELECT pgactive.pgactive_replicate_ddl_command($DDL$ DROP SCHEMA normalschema; $DDL$);
SELECT pgactive.pgactive_replicate_ddl_command($DDL$ DROP SCHEMA "strange.schema-IS"; $DDL$);
